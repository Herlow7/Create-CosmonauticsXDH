...
public record SerializableDimensionData(Optional<ResourceKey<Level>> key, Optional<AllowedTransfer> allowedTransfer,
    ...
    public static final Codec<SerializableDimensionData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.unboundedMap(Codec.STRING.xmap(Integer::parseInt, String::valueOf), AtmosphereFlags.CODEC.listOf().xmap(AtmosphereFlags::properCopy, ArrayList::new)).xmap(Int2ObjectRBTreeMap::new, i -> i).optionalFieldOf("atmosphere_composition").forGetter(p -> p.atmosphere),
